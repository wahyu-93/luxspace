    ...
    <section class="container mx-auto">
        <div class="flex flex-wrap my-4 md:my-12">
            ...
            <div class="flex-1">
                <div class="slider">
                    <div class="thumbnail">
                        @foreach ($product->galeries as $item)
                            <div class="px-2">
                    ...
                    <div class="preview">
                        <div class="item rounded-lg h-full overflow-hidden">
                            <img
                                src="{{ $product->galeries()->exists() ? Storage::url($product->galeries()->first()->url) : "data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" }}"
                                alt="front"
                                class="object-cover w-full h-full rounded-lg"/>
                        </div>
                    </div>
                    ...
                    <div class="px-3 flex-none" style="width: 320px">
                        <div class="rounded-xl p-4 pb-8 relative bg-white">
                            <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                                <img
                                    src="{{ $recomendation->galeries()->exists() ? Storage::url($recomendation->galeries()->first()->url) : "data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" }}"
                                    alt=""
